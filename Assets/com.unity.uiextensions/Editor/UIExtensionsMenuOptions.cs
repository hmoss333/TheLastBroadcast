...
namespace UnityEditor.UI
{
    ...
    static internal class ExtensionMenuOptions
	{
		...
		static public void AddUIButton(MenuCommand menuCommand)
		{
			...
			UnityEngine.UI.Button bt = uiButtonRoot.AddComponent<UnityEngine.UI.Button>();
		...
		static public void AddAutoCompleteComboBox(MenuCommand menuCommand)
		{
			...
			var itemTemplateButton = itemTemplate.GetComponent<UnityEngine.UI.Button>();
			...
			Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(autoCompleteComboBox.ToggleDropdownPanel), true);
			...
			Events.UnityEventTools.AddBoolPersistentListener(arrowButton.GetComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(autoCompleteComboBox.ToggleDropdownPanel), true);
		...
		static public void AddComboBox(MenuCommand menuCommand)
		{
			...
			overlayRT.pivot = new Vector2(0f, 1f);
			overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
			Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(comboBox.ToggleDropdownPanel), true);
			//Overlay Scroll Panel
			var overlayScrollPanelRT = overlayScrollPanel.GetComponent<RectTransform>();
			overlayScrollPanelRT.position += new Vector3(0, -cbbRT.sizeDelta.y, 0);
			overlayScrollPanelRT.anchorMin = new Vector2(0f, 1f);
			...
			arrowButtonRT.sizeDelta = new Vector2(cbbRT.sizeDelta.y, cbbRT.sizeDelta.y);
			arrowButtonRT.pivot = Vector2.one;
			Events.UnityEventTools.AddBoolPersistentListener(arrowButton.GetComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(comboBox.ToggleDropdownPanel), true);
			arrowButton.GetComponentInChildren<Text>().text = "▼";
		...
		static public void AddDropDownList(MenuCommand menuCommand)
		{
			...
			Events.UnityEventTools.AddBoolPersistentListener(mainButton.GetComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(dropDownList.ToggleDropdownPanel), true);
			...
			overlayRT.pivot = new Vector2(0f, 1f);
			overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
			Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<UnityEngine.UI.Button>().onClick, new UnityEngine.Events.UnityAction<bool>(dropDownList.ToggleDropdownPanel), true);
			//Overlay Scroll Panel
			var overlayScrollPanelRT = overlayScrollPanel.GetComponent<RectTransform>();
			overlayScrollPanelRT.position += new Vector3(0, -cbbRT.sizeDelta.y, 0);
			overlayScrollPanelRT.anchorMin = new Vector2(0f, 1f);
        ...
        static public void AddSegmentedControl(MenuCommand menuCommand)
        {
            ...
            for (int i = 0; i < 3; i++)
			{
                var button = AddButtonAsChild(go).GetComponent<UnityEngine.UI.Button>();
		...
		private static GameObject AddButtonAsChild(GameObject parent)
		{
            ...
            UnityEngine.UI.Button bt = buttonRoot.AddComponent<UnityEngine.UI.Button>();
			SetDefaultColorTransitionValues(bt);
